...
const BestSellers = () => {
  ...
  return (
    <section id='products' className={`${darkMode ? 'dark bg-[#19191a}' : 'light bg-slate-200'} w-full lg:px-20 px-10 lg:py-20 py-10 flex flex-col justify-center items-center gap-6 `}>
      ...
      <h1 className='text-5xl font-semibold dark:text-white text-black text-center'>Best Sellers</h1>
      <div data-aos='slid-up' data-aos-delay='200' className='w-full mt-3 '>
          ...
          bestsellers.map((item, index)=> (
            <div key={index} id='product-box' className='flex flex-col justify-center items-start gap-2 bg-white rounded-xl dark:bg-black'>
              <div  id='image-box' className='relative cursor-pointer '>
                ...
                <div id='icon-box' className='fle-col justify-center items-center gap-1 absolute top-3 right-3 hidden'>
              ...
              <div className='flex flex-col justify-center items-start gap-3 p-3 '>
                ...
                <button className='bg-black font-bold dark:bg-white dark:text-black text-rm text-white px-5 py-2 rounded-md transform hover:scale-105 transition-transform duration-300 mt-2'>Add to Cart</button>
              </div>
            </div>
          ))
        }
