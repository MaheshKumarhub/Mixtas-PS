...
const Banner = () => {
  ...
  return (
    <section className={`${darkMode ? 'dark bg-black' : 'light bg-white'} w-full lg:px-20 px-10 lg:py-20 py-10 flex lg:flex-row justify-center items-center gap-6`}>
      ...
      <div className='lg:w-[50%] w-full lg:p-10 flex flex-col justify-center items-center gap-8 '>
        ...
        <h1 data-aos='zoom-in' data-aos-delay='400' className='lg:text-5xl text-4xl font-bold text-black dark:text-white line-clamp-5 text-center ' >Unleash Your Style <br /> Potential with our <br /> Spectacular Clothing Sale </h1>
        <p data-aos='zoom-in' data-aos-delay='600' className='text-center text-xl text-slate-700 dark:text-white'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Recusandae rem, earum, odio velit dolorem sequi dignissimos ab placeat cumque harum quas. Accusantium odio quaerat sequi at ipsam asperiores explicabo reiciendis!</p>
