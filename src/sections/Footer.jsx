...
const Footer = () => {
  ...
  return (
    <>
    <section id='contact' className={`${darkMode ? 'dark bg-black' : 'light bg-white'}w-full lg:px-20 px-10 lg:py-20 py-10 flex flex-col justify-center items-center gap-6 `}>
    ...
    <section id='main-footer' className={`${darkMode ? 'dark bg-[#19191a]' : 'light bg-black'} w-full text-white px-10 lg:py-20 py-10 grid lg:grid-cols-5 grid-cols-1 justify-between items-start gap-14  `}>
      <div data-aos='zoom-in' data-aos-delay='200' className='flex flex-col justify-center items-start gap-5' >
        ...
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis laborum quis dolor natus. Consectetur obcaecati nisi delectus nostrum laborum atque.</p>
